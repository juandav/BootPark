@echo off
::
:: Encoding settings for 720p
:: You can change any VALUE below this line:
::


:: Video Size - Dimensions divisible by 16
:: Use 1280x720 for widescreen video, not existent on 4:3 video
SET SIZE=1280x720
...
:: Output
SET OUTPUT_FILE_NAME_NOT_INJECTED="%~d1%~p1%~n1.720pni.flv"
SET OUTPUT_FILE_NAME_INJECTED="%~d1%~p1%~n1.720p.flv"
